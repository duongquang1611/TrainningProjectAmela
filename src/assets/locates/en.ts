export default {
    ...
    error: {
        ...
        minAge: 'ít nhát 5 tuoi',
        infoInvalid: 'Invalid information.',
        notCompleted: 'Please fill in all the fields.',
        validatePassword: 'Pass contains at least 1 uppercase letter and 1 lowercase letter',
        passwordMinLength: 'At least 8 characters of password.',
        passwordMaxLength: 'At least 8 characters of password.',
    ...
    register: {
        ...
        address: 'Enter addresss',
        phone: '電話番号/メールアドレス',
        pass: 'Enter passworld...',
        resetPass: '再パスワード',
        submit: '新規登録',
    },
    follow: {
